void R15b_Am241Sim() {
  ...
  */
  /*  std::string data_filename = "output/out10483_si16-am241-calib.root";
  std::string mc_filename = "output/R15b_10M_Geom-C1-SiL1_Am241_110mmCloser.root";
  std::string channel = "SiL1-8-S";
  double front_z_position = 111.5;
  std::string M_volName = "SiL1";
  std::string flip = "-1*";
  */
  /*  std::string data_filename = "output/out10483_si16-am241-calib.root";
  std::string mc_filename = "output/R15b_10M_Geom-C1-SiL1_Am241_Mylar.root";
  std::string channel = "SiL1-8-S";
  double front_z_position = 1.5;
  std::string M_volName = "SiL1";
  std::string flip = "-1*";
  */
  /*  std::string data_filename = "output/out10483_si16-am241-calib.root";
  std::string mc_filename = "output/R15b_10M_Geom-C1-SiL1wDeadLayers_Am241.root";
  std::string channel = "SiL1-8-S";
  double front_z_position = 1.5;
  std::string M_volName = "SiL1";
  std::string flip = "-1*";
  */
  std::string data_filename = "output/out10483_si16-am241-calib.root";
  std::string mc_filename = "output/R15b_10M_Geom-C1-SiL1wProperDeadLayers_Am241.root";
  std::string channel = "SiL1-8-S";
  double front_z_position = 1.5;
  std::string M_volName = "SiL1";
  std::string flip = "-1*";
  ...
  for (int i_slice = 1; i_slice < n_slice_bins; ++i_slice) {
