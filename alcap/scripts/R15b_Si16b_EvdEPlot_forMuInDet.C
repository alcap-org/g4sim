...
void R15b_Si16b_EvdEPlot_forMuInDet() {
  std::string filename = "output/raw_g4sim.root";

  //  std::string filename = "output/R15b_200k_Geom-P5_muon-beam-sim_SF1-02.root";
  std::string outfilename = "MC_raw_spectra10404_muInDet.root";
  ...
  left_arm.thin_energy_thresholds.push_back(296); // turn on SiL1-1-S for beam pos studies
